...
dbutils.fs.mount(
    source="abfss://bronze@storageaccountgoda.dfs.core.windows.net/",
...
dbutils.fs.mount(
    source="abfss://silver@storageaccountgoda.dfs.core.windows.net/",
...
dbutils.fs.mount(
    source="abfss://gold@storageaccountgoda.dfs.core.windows.net/",
